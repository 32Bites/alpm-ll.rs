...
impl Alpm {
    pub fn set_log_cb<T: 'static, F: FnMut(LogLevel, &str, &mut T) + 'static>(
        ...
        unsafe { self.lib.alpm_option_set_logcb(self.as_ptr(), Some(cb), &*ctx as *const _ as *mut _) };
        c.replace(ctx);
    }
    ...
    pub fn set_dl_cb<T: 'static, F: FnMut(&str, AnyDownloadEvent, &mut T) + 'static>(
        ...
        unsafe { self.lib.alpm_option_set_dlcb(self.as_ptr(), Some(cb), &*ctx as *const _ as *mut _) };
        c.replace(ctx);
    }
    ...
    pub fn set_event_cb<T: 'static, F: FnMut(AnyEvent, &mut T) + 'static>(&self, data: T, f: F) {
        ...
        unsafe { self.lib.alpm_option_set_eventcb(self.as_ptr(), Some(cb), &*ctx as *const _ as *mut _) };
        c.replace(ctx);
    }
    ...
    >(
        ...
        unsafe { self.lib.alpm_option_set_progresscb(self.as_ptr(), Some(cb), &*ctx as *const _ as *mut _) };
        c.replace(ctx);
    }
    ...
    pub fn set_question_cb<T: 'static, F: FnMut(AnyQuestion, &mut T) + 'static>(
        ...
        unsafe { self.lib.alpm_option_set_questioncb(self.as_ptr(), Some(cb), &*ctx as *const _ as *mut _) };
        c.replace(ctx);
    }
    ...
    pub fn set_fetch_cb<T: 'static, F: FnMut(&str, &str, bool, &mut T) -> FetchResult + 'static>(
        ...
        unsafe { self.lib.alpm_option_set_fetchcb(self.as_ptr(), Some(cb), &*ctx as *const _ as *mut _) };
        c.replace(ctx);
    }
    ...
    pub fn take_raw_log_cb(&self) -> RawLogCb {
        ...
        let cb = RawLogCb {
            ctx: unsafe { self.lib.alpm_option_get_logcb_ctx(self.as_ptr()) },
            raw: unsafe { self.lib.alpm_option_get_logcb(self.as_ptr()) },
            cb: c.take(),
        };
        unsafe { self.lib.alpm_option_set_logcb(self.as_ptr(), None, ptr::null_mut()) };
        cb
    }
    ...
    pub fn set_raw_log_cb(&self, cb: RawLogCb) {
        ...
        unsafe { self.lib.alpm_option_set_logcb(self.as_ptr(), cb.raw, cb.ctx) };
        *c = cb.cb
    }
    ...
    pub fn take_raw_dl_cb(&self) -> RawDlCb {
        ...
        let cb = RawDlCb {
            ctx: unsafe { self.lib.alpm_option_get_dlcb_ctx(self.as_ptr()) },
            raw: unsafe { self.lib.alpm_option_get_dlcb(self.as_ptr()) },
            cb: c.take(),
        };
        unsafe { self.lib.alpm_option_set_dlcb(self.as_ptr(), None, ptr::null_mut()) };
        cb
    }
    ...
    pub fn set_raw_dl_cb(&self, cb: RawDlCb) {
        ...
        unsafe { self.lib.alpm_option_set_dlcb(self.as_ptr(), cb.raw, cb.ctx) };
        *c = cb.cb
    }
    ...
    pub fn take_raw_event_cb(&self) -> RawEventCb {
        ...
        let cb = RawEventCb {
            ctx: unsafe { self.lib.alpm_option_get_eventcb_ctx(self.as_ptr()) },
            raw: unsafe { self.lib.alpm_option_get_eventcb(self.as_ptr()) },
            cb: c.take(),
        };
        unsafe { self.lib.alpm_option_set_eventcb(self.as_ptr(), None, ptr::null_mut()) };
        cb
    }
    ...
    pub fn set_raw_event_cb(&self, cb: RawEventCb) {
        ...
        unsafe { self.lib.alpm_option_set_eventcb(self.as_ptr(), cb.raw, cb.ctx) };
        *c = cb.cb
    }
    ...
    pub fn take_raw_progress_cb(&self) -> RawProgressCb {
        ...
        let cb = RawProgressCb {
            ctx: unsafe { self.lib.alpm_option_get_progresscb_ctx(self.as_ptr()) },
            raw: unsafe { self.lib.alpm_option_get_progresscb(self.as_ptr()) },
            cb: c.take(),
        };
        unsafe { self.lib.alpm_option_set_progresscb(self.as_ptr(), None, ptr::null_mut()) };
        cb
    }
    ...
    pub fn set_raw_progress_cb(&self, cb: RawProgressCb) {
        ...
        unsafe { self.lib.alpm_option_set_progresscb(self.as_ptr(), cb.raw, cb.ctx) };
        *c = cb.cb;
    }
    ...
    pub fn take_raw_question_cb(&self) -> RawQuestionCb {
        ...
        let cb = RawQuestionCb {
            ctx: unsafe { self.lib.alpm_option_get_questioncb_ctx(self.as_ptr()) },
            raw: unsafe { self.lib.alpm_option_get_questioncb(self.as_ptr()) },
            cb: c.take(),
        };
        unsafe { self.lib.alpm_option_set_questioncb(self.as_ptr(), None, ptr::null_mut()) };
        cb
    }
    ...
    pub fn set_raw_question_cb(&self, cb: RawQuestionCb) {
        ...
        unsafe { self.lib.alpm_option_set_questioncb(self.as_ptr(), cb.raw, cb.ctx) };
        *c = cb.cb;
    }
    ...
    pub fn take_raw_fetch_cb(&self) -> RawFetchCb {
        ...
        let cb = RawFetchCb {
            ctx: unsafe { self.lib.alpm_option_get_fetchcb_ctx(self.as_ptr()) },
            raw: unsafe { self.lib.alpm_option_get_fetchcb(self.as_ptr()) },
            cb: c.take(),
        };

        unsafe { self.lib.alpm_option_set_fetchcb(self.as_ptr(), None, ptr::null_mut()) };
        cb
    }
    ...
    pub fn set_raw_fetch_cb(&self, cb: RawFetchCb) {
        ...
        unsafe { self.lib.alpm_option_set_fetchcb(self.as_ptr(), cb.raw, cb.ctx) };
        *c = cb.cb;
    }
}
