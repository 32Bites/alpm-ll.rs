use alpm_ll::{Alpm, SigLevel, Usage};
...
/// # }
/// ```
pub fn alpm_with_conf(conf: &Config) -> alpm_ll::Result<Alpm> {
...
/// # }
/// ```
pub fn configure_alpm(alpm: &mut Alpm, conf: &Config) -> alpm_ll::Result<()> {
...
fn register_db(alpm: &mut alpm_ll::Alpm, repo: &pacmanconf::Repository) -> alpm_ll::Result<()> {
